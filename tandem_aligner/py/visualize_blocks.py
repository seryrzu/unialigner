...
def plot_blocks(blocks, str1_name, str2_name, outdir, min_len=1):
    ...
    for block, col in zip(blocks, color):
        rect1 = matplotlib.patches.Rectangle((block.st1, 0),
                                             block.en1-block.st1, 1,
                                             color=col,
                                             alpha=0.7)
        rect2 = matplotlib.patches.Rectangle((block.st2, 0),
                                             block.en2-block.st2, 1,
                                             color=col,
                                             alpha=0.7)
    ...
    ax[1].set_xticklabels(labels=np.arange(0, xmax, step),
                          rotation=30,
                          fontsize=14)
